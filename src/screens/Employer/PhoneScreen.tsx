...
export default function PhoneScreen() {
    ...
    const handleNext = () => {
        if (!isVerified) return Alert.alert("Verification Required");
        navigation.navigate("AddressScreen", { ...prevData, phone });
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.progressBarBg}><View style={[styles.progressBarFill, { width: "75%" }]} /></View>

            <View style={styles.content}>
                <View style={styles.iconCircle}><Icon name="cellphone-check" size={32} color="#0f172a" /></View>
                <Text style={styles.title}>Phone Number</Text>
                <Text style={styles.subtitle}>Secure your account with mobile.</Text>
                ...
                <View style={styles.modalBg}>
                    <View style={styles.modalCard}>
                        ...
                        <TouchableOpacity style={styles.modalVerifyBtn} onPress={verifyOtp}>
                            {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.nextText}>Verify Now</Text>}
                        </TouchableOpacity>
