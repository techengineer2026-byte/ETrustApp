...
export default function ContactVerificationScreen() {
    ...
    // --- DERIVED HELPERS ---
    // These determine what to show based on the current tab
    ...
    const handleTextChange = (text: string) => {
        ...
        if (mode === "email") {
            setEmail(text);
            setIsEmailVerified(false); // Reset verification if they type
        } else {
            setPhone(text.replace(/[^0-9]/g, ""));
            setIsPhoneVerified(false); // Reset verification if they type
        }
    };
    ...
    // Allow user to edit a verified field
    const handleEdit = () => {
                    ...
                    <View style={styles.content}>
                        <View style={styles.titleBlock}>
                            ...
                            <Text style={styles.subtitle}>
                                How should candidates contact you? Verify to proceed.
                            </Text>
                        </View>
                        ...
                        <Animated.View style={[
                            ...
                            <View style={styles.inputRow}>
                                <TextInput
                                    ...
                                    placeholder={mode === "email" ? "hr@company.com" : "9876543210"}
